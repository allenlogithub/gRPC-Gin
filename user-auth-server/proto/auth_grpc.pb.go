...
func (c *authServiceClient) ValidateJWT(ctx context.Context, in *JWTValidationRequest, opts ...grpc.CallOption) (*JWTValidationReply, error) {
	out := new(JWTValidationReply)
	err := c.cc.Invoke(ctx, "/proto.AuthService/ValidateJWT", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthServiceServer) ValidateJWT(context.Context, *JWTValidationRequest) (*JWTValidationReply, error) {
...
func _AuthService_ValidateJWT_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.AuthService/ValidateJWT",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).ValidateJWT(ctx, req.(*JWTValidationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
